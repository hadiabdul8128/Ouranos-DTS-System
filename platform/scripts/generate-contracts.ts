...
const models = {
  ...
  Session:z.object({user:z.object({id:uuid,email:z.string().optional()}), memberships:z.array(z.object({organizationId:uuid,name:z.string(),role:roleSchema})), contractVersion:z.string()}),
